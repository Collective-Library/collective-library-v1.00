...
export interface CollectiveMapCanvasProps {
  items: CollectiveMapItem[];
  /**
   * Height of the MapContainer. Accepts a pixel number (default: 480) or any
...
/**
 * Reusable Leaflet map canvas rendering CollectiveMapItem pins.
 *
 * Presentational — receives items and renders markers + popups. Supports a
 * configurable height so it can be embedded as a 480px card (/peta) or fill a
 * fullscreen surface (/maps in a future slice).
 *
 * IMPORTANT: This component imports Leaflet, which requires window/document at
 * import time. It must always be loaded via dynamic import with ssr:false.
...
// the original members-only behaviour. Exact items (public Spots/events) are
// placed verbatim and never jittered.
// =============================================================================
