...
const SECTIONS: { slug: string; label: string; emoji: string; href: string; phase: 1 | 2 | 3 }[] = [
  ...
  {
    slug: "requests",
    label: "Buku Dicari (WTB)",
    emoji: "🔎",
    href: "/mastermind/requests",
    phase: 1,
  },
        ...
        return (
          <Link
            ...
            className={cn(
              ...
              active ? "bg-ink text-parchment" : "text-ink-soft hover:bg-cream hover:text-ink"
            )}
