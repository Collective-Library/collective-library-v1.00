  ...
  return (
    <header className="sticky top-0 z-40 bg-paper/85 backdrop-blur-md border-b border-hairline-soft">
      <div className="mx-auto max-w-6xl px-4 md:px-6 h-16 flex items-center justify-between gap-3">
        <Link href="/shelf" aria-label="Collective Library — Beranda" className="flex items-center gap-2">
          <Logo size={32} />
        ...
        <Link
          href="/search"
          className="hidden md:flex flex-1 max-w-md mx-4 items-center gap-3 h-11 px-5 rounded-pill bg-paper border border-hairline-strong text-muted hover:shadow-card transition-shadow"
        >
          <SearchIcon />
