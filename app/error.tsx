  ...
  return (
    <div className="min-h-screen bg-parchment text-ink flex items-center justify-center px-6">
      <div className="max-w-md text-center">
        <p className="text-caption text-muted uppercase tracking-wide font-semibold">Aduh</p>
        <h1 className="mt-2 font-display text-display-lg text-ink leading-tight">
          Ada yang error.
        </h1>
        <p className="mt-3 text-body text-ink-soft">
          Sesuatu yang gak diduga terjadi. Tim udah dapet notif, sambil lo coba lagi tombol di
          bawah.
        </p>
        {error.digest && (
          <p className="mt-2 text-caption text-muted font-mono">ID: {error.digest}</p>
        )}
