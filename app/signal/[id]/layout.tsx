...
/**
 * Public layout for /signal/[id]. Mirrors /profile/[username]/layout.tsx:
 * authed users get BottomNav, anon visitors get Masuk/Daftar CTAs.
 * No auth gate — Signal pages are shareable (Discord links, IG Story).
 */
export default async function SignalDetailLayout({ children }: { children: React.ReactNode }) {
