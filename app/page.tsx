...
import { EcosystemLoopExplainer } from "@/components/landing/ecosystem-loop-explainer";
    ...
    <LoginNudgeProvider isAnon={!user}>
      <div className="min-h-screen bg-parchment text-ink flex flex-col">
        ...
        <main id="main" className="flex-1">
          ...
          <section className="px-6 md:px-10 pt-12 md:pt-20 pb-16">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="mt-6 text-body-lg md:text-[20px] text-ink-soft max-w-2xl mx-auto leading-relaxed">
                Bukan platform jual-beli buku. Ini infra untuk komunitas pembaca yang udah saling
                kenal. Biar rak kolektif kita keliatan, dan ide berpindah tangan tanpa hilang di
                chat.
              </p>
          ...
          {/* Ecosystem loop explainer — how the network signal works */}
          <EcosystemLoopExplainer />
          ...
          <section className="px-6 md:px-10 py-16 bg-cream">
            <div className="max-w-2xl mx-auto">
              ...
              <div className="mt-8 flex flex-col gap-4 text-body-lg text-ink-soft leading-relaxed">
                <p>
                  &ldquo;Bro, ada yang punya Sapiens? Mau pinjem.&rdquo; Pesan begitu lewat di grup
                  WA, terus ke-bury sama 200 chat lain dalam sehari. Reset chat. Mulai dari nol lagi
                  bulan depan.
                </p>
                <p>
                  Padahal buku-bukunya <em>ada</em>. Tersebar di rak personal kita masing-masing.
                  Trust antar anggota juga udah ada. Kita udah saling kenal di Journey Perintis.
                  Tapi gak ada satu tempat yang bikin itu semua kelihatan dan bisa dicari.
                </p>
                <p>
                  Collective Library bikin yang gak keliatan jadi keliatan. Bukan&nbsp;Goodreads
                  versi Indo. Bukan Tokopedia buat buku. Ini infra untuk komunitas yang sudah ada.
                </p>
              </div>
          ...
          <section className="px-6 md:px-10 py-16 bg-cream">
            <div className="max-w-2xl mx-auto text-center">
              ...
              <p className="mt-3 text-body-lg text-ink-soft">
                Daftar gratis, list 5 buku dalam ~2 menit, dan jadi bagian dari jaringan pembaca
                yang lagi tumbuh.
              </p>
...
function Stat({ number, label }: { number: number; label: string }) {
  return (
    <div className="flex flex-col items-center">
      <span className="font-display text-display-md text-ink leading-none">{number}</span>
